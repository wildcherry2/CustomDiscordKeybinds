...
//    vector<int> keycodes; //use array of preset size to 4, terminated by argc - 1? more efficient, no rearranging, could probably save a function call and not use getKeyCodes
//    
...
//        Helpers::getEnabled(isEnabled); //can take out in class file
//    }
//
//    return 0;
//}
